# REVOLT Classic Simulation Agent Instructions

This package owns the REVOLT Classic instrument simulation. It depends on
AdaptiveOpticsSim.jl for reusable physics, algorithms, graph execution, and
HIL boundaries.

- Keep REVOLT Classic configuration, calibration provenance, graph files,
  detector settings, integration code, and instrument validation here.
