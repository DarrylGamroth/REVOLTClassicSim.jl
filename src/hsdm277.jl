# Exact nonzero payload from the maintained Classic source artifact:
# - heart/revolt-on-sky origin/OnSky@27aac39, config/dmActuatorMap_277.csv
#   raw SHA-256 b75ae701627b24af51ecd50f019e91989a514441a0d510b418b5fe82b6127fd1
#
# The Copper source currently has an identical 19-by-19 payload but remains
# independently owned by REVOLTCopperSim. This package retains the Classic
...
maintained on-sky source artifact; they do not by themselves define a
